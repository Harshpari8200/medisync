...
import { Check, HeartIcon, HomeIcon, Microscope, ShieldAlertIcon, Stethoscope, UserIcon, ZapIcon } from "lucide-react"
...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-white">
      ...
      <div className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg bg-background p-20">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-12 pt-20">
          ...
          <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
            Our cutting-edge medical systems streamline patient care, enhance diagnostic accuracy, and improve overall healthcare efficiency. Experience the future of healthcare with our innovative solutions.
          </p>
      ...
      <section id="Features" className="flex flex-col items-center justify-center w-full py-20">
        <div className="section-here max-w-5xl mx-auto text-center space-y-12">
          <h2 className={cn("text-4xl md:text-5xl font-bold tracking-tight", giga.className)}>Features so good you'll
            <span className="text-blue-500"> Love us</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
            Packed with thousands of features, we are going to show you only 4 because bento looks the best with that
          </p>
          {/* Bento Grid */}
          <BentoGrid className="mt-12">
            ...
            <BentoCard
              ...
              className="col-span-3 lg:col-span-1"
              cta="Learn More"
              background={<div className="bg-gradient-to-br from-blue-500 to-blue-400" />}
            />
            <BentoCard
      ...
      <section id="Ai" className="flex flex-col items-center justify-center w-full py-2">
        <FeatureCards />
      </section>
      <section id="testimonial" className="flex  items-center justify-between w-full py-10 px-20">
        <div className="">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="pr-4">
              ...
              <p className="text-xl text-gray-600 mb-8">
                People love us for our scheduling software. Even though they don't use it, we make sure to get a testimonial from them.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">Prove your point to a stakeholder</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">Find topics you need to research</p>
                </div>
              </div>
